(function executeRule(current, previous /*null when async*/) {
    ...
    inc_task.assignment_group = parent.assignment_group;
    ...
    inc_task1.assignment_group = parent.assignment_group;
	...
	var inc_task2 = new GlideRecord('incident_task');
    ...
    inc_task2.assignment_group = parent.assignment_group;
	...
	var inc_task3 = new GlideRecord('incident_task');
    ...
    inc_task3.assignment_group = parent.assignment_group;
    ...
    function getAssignmentGroup()
	{
		...
		if(deployedTo != ''){
			...
			if(getUser.next())
			{
				var getGroup = new GlideRecord('u_assignment_group')
				    getGroup.addQuery('u_location', getUser.location);
					getGroup.addQuery('u_product', '');
					getGroup.query();
					if(getGroup.next())
					{
